...
const Lupa: React.FC<{ className?: string }> = ( { className }) => (
    ...
    <path d="M40 14.7059C40 21.6107 34.0158 27.4118 26.375 27.4118C18.7342 27.4118 12.75 21.6107 12.75 14.7059C12.75 7.80111 18.7342 2 26.375 2C34.0158 2 40 7.80111 40 14.7059Z" stroke="white" strokeWidth="4"/>
    <line y1="-2" x2="24.8674" y2="-2" transform="matrix(-0.653466 0.756956 -0.794358 -0.60745 16.25 23)" stroke="white" strokeWidth="4"/>
    </svg>
)
